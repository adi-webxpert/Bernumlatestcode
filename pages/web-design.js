...
const WebDesign = () => {
  return (
    <>
      <Head>
        <title>
          Web Design Company Vancouver | responsive Web Design | Bernum
        </title>
        <link href="https://www.bernum.ca/web-design/" rel="canonical" />

        <meta
          name="description"
          content="Web Design Vancouver - Bernum is a web design company offering unique and 
          responsive web design, web development and eCommerce website 
          services.Contact us now."
        />
        <meta
          name="keywords"
          content="web design vancouver, responsive web design, website design and development, web design and development, web design kingston ontario, affordable web design vancouver, ecommerce web design vancouver, web design company mississauga, web design company montreal"
        />

        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.bernum.ca/web-design/" />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Web Design Company Vancouver | responsive Web Design |  Bernum"
        />
        <meta
          property="og:description"
          content="Web Design Vancouver - Bernum is a web design company offering unique and responsive web design, web development and eCommerce website services.Contact us now."
        />
      </Head>
      <NavbarStyleTwo />

      <PageBanner pageTitle="Responsive Web Design Solutions" />
        ...
        <div className="container">
          <div className="overview-box">
            ...
            <div className="overview-image">
              <div className="image">
                <img src="/images/services/web-design-1.jpg" alt="image" />
              </div>
            </div>
          </div>
          ...
          <div className="overview-box">
            <div className="overview-image">
              <div className="image">
                <img src="/images/services/web-design-2.jpg" alt="image" />
              </div>
            </div>
            ...
            <div className="overview-content">
              <div className="content right-content">
                ...
                <ul className="features-list">
                  <li>
                    <span>
                      <i className="bx bx-check"></i> Fully Structured
                    </span>
                  </li>
                  <li>
                    <span>
                      <i className="bx bx-check"></i> Simple Navigation.
                    </span>
                  </li>
                  <li>
                    <span>
                      <i className="bx bx-check"></i> Mobile friendly.
                    </span>
                  </li>
                  <li>
                    <span>
                      <i className="bx bx-check"></i> Fast Loading Time.{" "}
                    </span>
                  </li>
                  <li>
                    <span>
                      <i className="bx bx-check"></i> Effective Visual Design.{" "}
                    </span>
                  </li>
                  <li>
                    <span>
                      <i className="bx bx-check"></i> User Friendly Layout.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className="container">
          <div className="section-title">
            ...
            <p>
              ...
              firm, which holds the capability to make them look different with
