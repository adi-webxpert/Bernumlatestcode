  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Bernum Is Now Elevating Your Online Presence with Affordable Web Design in Vancouver, Canada. To Know More Connect Today!"
        />
         <link href="https://www.bernum.ca/affordable-web-design-vancouver/" rel="canonical" />

<meta property="og:locale" content="en_US" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://www.bernum.ca/affordable-web-design-vancouver/" />
<meta
  property="og:image"
...
<meta
  property="og:title"
  content="Most Affordable Web Design Vancouver Experts - Bernum"
/>
<meta
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            ...
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              ...
              Vancouver is our passion and service, not merely an offering we
              render. With years of experience and a track record that speaks
              for itself, we've assisted numerous Vancouver businesses establish
              a strong web presence without busting their budgets.
            </p>
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              Affordable Web Design Vancouver provides the ideal blend of
              ...
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  <div>
                    ...
                    <svg   className="h-8 w-8 text-white"  fill="white" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
            ...
            <div className="h-full pt-6">
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    We take great pride in crafting websites to fit the specific
                    needs and desires of each of our Vancouver client companies,
                    creating personalized online presences.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  <div>
                    <span className="inline-flex items-center justify-center rounded-md  bg-rose-500 p-3 shadow-lg">
                    <svg  fill="white"
                        className="h-8 w-8 text-white" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
