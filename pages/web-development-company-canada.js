  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Your Trusted Web Development Company in Canada. Elevate Your Online Presence with Us. Connect with Us Today for More Information"
        />
        <link
          href="https://www.bernum.ca/web-development-company-canada/"
          rel="canonical"
        />
        ...
        <meta
          property="og:url"
          content="https://www.bernum.ca/web-development-company-canada/"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Most Trusted Web Development Company Canada - Bernum"
        />
        <meta
        ...
        <div className="row justify-center mx-6 mt-12">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
              ...
              Company Canada. When it comes to designing extraordinary website
              solutions, Bernum is your reliable partner. Our mission is to meet
              the diverse needs of clients, from visionary entrepreneurs
              embarking on start-up journeys all the way up to experienced
              business professionals representing Fortune 500 companies, with
              each client receiving top-tier web development services that not
              only meet but surpass expectations at an affordable cost. Here at
              Bernum, we deliver outstanding web services designed to exceed
              expectations while staying within your budget restrictions.
            </p>
            <p className="text-3xl text-base leading-snug text-gray-600 md:mt-2 md:leading-relaxed poppinFont">
            ...
            <div className="h-full pt-6">
              <div className="flow-root h-full rounded-lg bg-gray-50 px-6 pb-8">
                <div className="-mt-6 text-center">
                  ...
                  <p className="mt-2 text-base leading-snug text-gray-500 md:mt-4 md:leading-relaxed">
                    Responsive Web Designs' mobile-friendly designs ensure
